...
add_action('wp_head', 'get_style_sheet_css');
function get_style_sheet_css(){
?>
	<style>
		@font-face {
		  font-family: 'Clash Display';
		  src: url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/ClashDisplay-Medium.woff2') format('woff2'),
			   url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/ClashDisplay-Medium.woff') format('woff'),
			   url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/ClashDisplay-Medium.ttf') format('truetype');
		  font-weight: 500;
		  font-display: swap;
		  font-style: normal;
		}
		.cat-products-wrap-row {
			display: grid;
		...
		.image_wrap img {
			box-shadow: -13px 35px 37px 0px #00000017;
			border-radius: 100%;
			display: block;
			margin: 0 auto 40px;
		}
		.product_extra_content h4 {
			font-size: 20px;
			margin-bottom: 25px;
		}
		.add_to_cart_wrap .button.add_to_cart_button {
		...
		.add_to_cart_wrap .button.add_to_cart_button:hover{ background: var(--e-global-color-primary);}
		.meal-extra {
			display: grid;
		...
		.extra-meal-opt label:before {
			content: url(/wp-content/uploads/2025/04/checkbox-uncheck-icon.png);
			margin-right: 7px;
			vertical-align: middle;
		}

		.extra-meal-opt input[type="checkbox"]:checked + label:before {
			content: url(/wp-content/uploads/2025/04/checkbox-checked-icon.png);
			margin-right: 7px;
			vertical-align: middle;
		}
		.add_to_cart_wrap {
		...
		.add_to_cart_wrap input[type="number"] {
			padding: 10px;
			margin-right: 8px;
			height: 50px;
			text-align: center;
		...
		.add_to_cart_wrap a.added_to_cart.wc-forward {
			display: none;
		}
		.category_filter .elementor-shortcode .cat_product_grid:last-child {
			border-bottom: none;
			margin-bottom: 0;
		}
		button#loadMoreBtn {
		...
		.single-product.postid-999 .product_meta, .single-product.postid-999 .woocommerce-tabs, .single-product.postid-999 .related.products, .single-product.postid-999 .woocommerce-breadcrumb, .single-product.postid-999 .summary > .price {
			display: none;
		}
		...
		.wp-block-woocommerce-cart-order-summary-block > div:first-child {
			border-top: 0;
		}
		...
		.wc-block-formatted-money-amount {
			...
			.wc-block-formatted-money-amount:not(.wc-block-formatted-money-amount.wc-block-components-product-price__value):not(.wc-block-formatted-money-amount.wc-block-components-totals-item__value){ color: var(--e-global-color-accent); }
			.is-large.wc-block-cart .wc-block-cart-items td,
			.wp-block-woocommerce-cart-order-summary-totals-block,
			.wc-block-components-totals-wrapper { border-color: #19191933; }
			...
			.wc-block-components-totals-coupon__input label{ display:none;}
			.is-large.wc-block-cart .wc-block-cart-items {
					border-bottom: none;
				}
		...
		body.woocommerce-account .col2-set .u-column2{ width:100%; float:none;}
		...
		p.woocommerce-LostPassword.lost_password a:hover{ color:var( --e-global-color-accent );} 
		...
		.myaccount_custom_text {
			text-align: center;
			color: #000;
		}
		.myaccount_custom_text a {
			font-weight: bold;
		}
		.register_title_box:not(.active_registration_form .register_title_box),
		.active_registration_form .login_title_box  {
			display: none;
		}
		...
		dl.variation .amount{ font-weight:600; font-family:var(--e-global-typography-primary-font-family); }
		...
		.add_gift_card_form input {
			border: 1px solid #B59B92 !important;
			padding: 12px;
		}
		...
		.woocommerce-checkout-review-order-table tbody td .amount {
			color: var( --e-global-color-accent );
		}
		.woocommerce-checkout-review-order-table  dl.variation .amount {
			font-size: 14px;
		}
		...
		.checkout_loop_image img{
			box-shadow:-13px 35px 37px 0px #00000017;
			border-radius:100%;
		}
		.checkout_product_loop {
			display: flex;
			flex-wrap: wrap;
		}
		...
		.woocommerce-checkout-review-order-table tfoot tr td, .woocommerce-checkout-review-order-table tfoot tr th {
			border-top: 1px solid #19191933 !important;
		}
		.woocommerce-checkout-review-order-table tr.cart_item:last-child td,
		.woocommerce-checkout-review-order-table tr.cart_item:last-child th{ padding-bottom:30px;}

		.checkout_loop_image .product-quantity {
			background: #F28280;
			width: 25px;
			height: 25px;
			border-radius: 100%;
		...
		/*___Gift Card____*/
		.wc_gc_giftcard_product .woocommerce-product-gallery{ display:none;}
		.wc_gc_giftcard_product .summary.entry-summary {
			float: none !important;
			width: 100% !important;
			max-width: 750px;
			margin: 0 auto;
		...
		.wc_gc_giftcard_product input, .wc_gc_giftcard_product textarea {
			outline: none !important;
			border: 1px solid #B59B92 !important;
		...
		.wc_gc_giftcard_product button.single_add_to_cart_button:after {
			content: "Send Gift Card";
			font-size: 18px;
		}
		.wc_gc_giftcard_product .woocommerce-variation-price {
			text-align: center;
			padding-bottom: 15px;
		}
		.wc_gc_giftcard_product .woocommerce-variation-price .amount {
			color: var(--e-global-color-primary);
			font-family: 'Clash Display';
			font-weight: 600;
		}

		.wc_gc_giftcard_product form.cart .variations td{ line-height:0 !important;}
		.wc_gc_giftcard_product form.cart .variations th label{
			font-weight: 400 !important;
			font-size:16px;
		}
		.wc_gc_giftcard_product .woocommerce-product-details__short-description {
			text-align: center;
			padding-bottom: 30px;
		}
		.wc_gc_giftcard_product h1.product_title.entry-title {
			text-align: center;
			font-size:48px;
		}
		.wc_gc_giftcard_product a.reset_variations {
			display: none !important;
		}

		body.postid-999 div#primary {
			background-image: url(/wp-content/uploads/2025/05/Tomato-slice-right.png);
			background-repeat: no-repeat;
			background-position: right top 100px;
			background-size: 60px;
			position:relative;
		}
		body.postid-999 div#primary:before {
			content: "";
			background-image: url(/wp-content/uploads/2025/05/onnion-left.png);
			position: absolute;
			left: 0;
			top: 50%;
			width: 79px;
		...
		.e-checkout__order_review-2 p.form-row .woocommerce-input-wrapper input[type="radio"] {
		  display: none;
		}
		#delivery_for_not_home_field > label.required_field {
			color: #191919;
			font-family: 'Clash Display';
			font-weight: 500;
			font-size: 15px;
		...
		.e-checkout__order_review-2 p.form-row.validate-required .woocommerce-input-wrapper label {
			cursor: pointer;
			display: flex;
			align-items: center;
			flex-wrap: wrap;
		...
		.e-checkout__order_review-2 p.form-row.validate-required .woocommerce-input-wrapper label::before {
		  content: '';
		  display: inline-block;
		  width: 16px;
		  height: 16px;
		  border: 2px solid #F28280;
		  border-radius: 50%;
		  margin-right: 8px;
		...
		/* Checked styling */
		.e-checkout__order_review-2 p.form-row.validate-required .woocommerce-input-wrapper input[type="radio"]:checked + label::before {
		  border:5px solid #F28280
		}

		#insulated_bag_fee_field label {
			cursor: pointer;
			color: #191919;
			font-family: 'Bricolage Grotesque';
			font-weight: 500;
		...
		#insulated_bag_fee_field {
			padding-bottom: 25px;
		}
		#insulated_bag_fee_field  .ch-info-circle{ font-size:0;}
		#insulated_bag_fee_field  .ch-info-circle:before {
			content: url(/wp-content/uploads/2025/05/akar-icons_info-fill.png);
			position: relative;
			top: 2px;
			left: 4px;
		}
		#insulated_bag_fee_field .ch-info-circle.actv:after {
		...
		.wc_gc_giftcard_product table.variations td.value {
		  background-color: transparent;
		  width: 100%;
		  display: block;
		  padding:0;
		}
		.wc_gc_giftcard_product table.variations th.label{ padding-bottom:5px;}
		.wc_gc_giftcard_product form label {
			font-size: 16px;
			font-weight: normal;
			line-height: 1.2em !important;
			margin-bottom: 5px;
		}
		.woocommerce div.product form.cart .woocommerce_gc_giftcard_form .variations select {
			min-width: 100%;    
			height: 48px;
			border: 1px solid #B59B92 !important;
			outline: none !important;
		}
		.woocommerce div.product form.cart .woocommerce_gc_giftcard_form .variations {
			margin-bottom: 0 !important;
		}
		.wc_gc_field.wc_gc_giftcard_from label,
		.wc_gc_field.wc_gc_giftcard_to_multiple label{
			font-size: 0;
		}
		.wc_gc_field.wc_gc_giftcard_from label:before {
			content: "Your name if it's from you";
			font-size: 16px;
			line-height: 1.2em;
			margin-right:4px;
		}
		.wc_gc_field.wc_gc_giftcard_to_multiple label:before {
			content: "Who you are giving this to";
			font-size: 16px;
			line-height: 1.2em;
			margin-right:4px;
		}
		.wc_gc_giftcard_product .form-row .required {
			font-size: 14px !important;
		}
		...
		body.active_login_form .default_header,
		body.active_registration_form .default_header { display:none !important; }
		.wcs-recurring-totals-panel__details, .shipping.recurring-total input.shipping_method, .subsc-meal-product .product-action .added_to_cart {
			display: none;
		}
		...
		#order_review table tr.gift-card td small.codes_label, #order_review table tr.gift-card td small.code {
			display: none;
		}
		.woocommerce-checkout #wc_gc_cart_redeem_send {
			height: 50px;
		}
		.wc-stripe_cc-container label.wc-stripe-label-payment-type {
		...
		@media (max-width: 767px){
			...
			.category_filter .e-n-tabs-heading {
				display: flex;
				flex-wrap: wrap;
			}
			.elementor.elementor .category_filter.elementor-widget-n-tabs.e-n-tabs-mobile .e-n-tab-title[aria-selected=true] { margin-block-end: 0; }
			.elementor.elementor .category_filter.elementor-widget-n-tabs.e-n-tabs-mobile .e-n-tab-title:not(:first-child) { margin-block-start: 0; }
			.site-main .page-header h1.entry-title { padding: 50px 0 40px; font-size:32px; }
			.wc_gc_giftcard_product h1.product_title.entry-title { font-size:32px;}
			body.postid-999 div#primary:before{ display:none;}
			.woocommerce_gc_giftcard_form > * {
				width: 100% !important;
				margin-bottom: 15px !important;
			}
		...
		@media (max-width: 575px){
			...
			.cat_product_grid {  max-width: 370px;  margin: 0 auto; }
			.image_wrap img { margin: 0 auto 20px; max-width: 160px; }
			.product_extra_content h4 {
				margin-bottom: 20px;
				text-align: center;
				font-size: 16px;
